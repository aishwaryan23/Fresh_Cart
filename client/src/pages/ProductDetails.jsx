    ...
    return product && (
        <div className="mt-16">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <button onClick={()=>{navigate('/products');scrollTo(0,0)}} className="mx-auto cursor-pointer my-16 px-12 py-2.5 text-primary border rounded  hover:bg-primary/10 transition">See More</button>
            </div>
        </div>
    );
};
